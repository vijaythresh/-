package com.vijaythresh.loans.bean;
import javax.persistence.*;

import java.sql.Timestamp;

@Entity
@Table(name = "nplm_borrower_info", schema = "loans", catalog = "")
public class NplmBorrowerInfoEntity {
    private int id;
    ...
    public boolean equals(Object o) {
        ...
        NplmBorrowerInfoEntity that = (NplmBorrowerInfoEntity) o;
