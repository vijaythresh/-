...
@Entity
@Table(name = "nplm_contract_attribute", schema = "loans", catalog = "")
public class NplmContractAttributeEntity {
    ...
    public boolean equals(Object o) {
        ...
        NplmContractAttributeEntity that = (NplmContractAttributeEntity) o;
        ...
        if (def4 != null ? !def4.equals(that.def4) : that.def4 != null) return false;
        if (def5 != null ? !def5.equals(that.def5) : that.def5 != null) return false;
        if (def6 != null ? !def6.equals(that.def6) : that.def6 != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (def4 != null ? def4.hashCode() : 0);
        result = 31 * result + (def5 != null ? def5.hashCode() : 0);
        result = 31 * result + (def6 != null ? def6.hashCode() : 0);
